...
class BeaconReferenceApplication: Application() {
    ...
    fun setupForegroundService() {
        ...
        val intent = Intent(this, MonitoringFragment::class.java)
...
//            sendNotification()
    ...
    val centralRangingObserver = Observer<Collection<Beacon>> { beacons ->
        Log.d(MonitoringFragment.TAG, "Ranged: ${beacons.count()} beacons")
    ...
    private fun sendNotification(distance: Int) {
        ...
        stackBuilder.addNextIntent(Intent(this, MonitoringFragment::class.java))
